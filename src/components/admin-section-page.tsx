...
const columns:Record<string,AdminColumn[]>={
 ...
 placements:[{key:"talent_id",label:"Talent ID"},{key:"staffing_role_id",label:"Role ID"},{key:"agreed_rate",label:"Agreed rate (INR)"},status(),{key:"completed_at",label:"Completed",format:v=><DateCell value={v}/>},date()],
