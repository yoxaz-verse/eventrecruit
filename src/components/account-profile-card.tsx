...
export async function AccountProfileCard({ id, role, fullName, email, phone, avatarUrl, saved = false }: { id: string; role: UserRole; fullName: string; email: string; phone: string; avatarUrl?: string | null; saved?: boolean }) {
