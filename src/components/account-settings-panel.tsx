...
import type { AccountSettingsAvailability } from "@/lib/account-settings-state";

type AccountSettingsPanelProps = {
  emailNotifications: boolean;
  inAppNotifications: boolean;
  deletionPending: boolean;
  availability: AccountSettingsAvailability;
};

export function AccountSettingsPanel({ emailNotifications, inAppNotifications, deletionPending, availability }: AccountSettingsPanelProps) {
