      ...
      <main className="page py-12">
        <section className="panel p-8">
          ...
          <p className="mt-3 max-w-3xl leading-8 text-[var(--muted)]">
            Complete your role profile next. Event talent enter verification, exhibitors add company
            details, and agencies create their agency record before matching talent to client needs.
          </p>
          <form action={completeOnboarding} className="mt-6 grid gap-4">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              <label className="label">Business name<input className="input" name="business_name" placeholder="For agencies or exhibitors" /></label>
              <label className="label">Industry<input className="input" name="industry" placeholder="For exhibitors" /></label>
            </div>
            <div className="grid gap-3 md:grid-cols-2">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              <label className="label">Skills<input className="input" name="skills" placeholder="Lead capture, Greeting" /></label>
              <label className="label">Languages<input className="input" name="languages" placeholder="English, Hindi" /></label>
            </div>
            <div className="grid gap-3 md:grid-cols-2">
              <label className="label">Availability<input className="input" name="availability" /></label>
